"""
Automated Pytest for cxr-multimodal-report-grounder Enrichment Modules.
"""
import sys
...
from enrichment import (
    ...
    PriorEngine,
    QualityEngine,
    CxrmultimodalreportgrounderEnrichmentSuite,
    enrichment_suite,
)

def test_enrichment_suite_execution():
    suite = CxrmultimodalreportgrounderEnrichmentSuite()
