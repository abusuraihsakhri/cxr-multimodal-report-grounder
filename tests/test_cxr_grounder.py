...
import pytest
from cxr_grounder.models import FrontierPayload, ExecutionStatus
from cxr_grounder.engine import FrontierDomainEngine
from cxr_grounder.agents import VisualEmbeddingSpatialAgent, TextEntityGroundingAgent, IntersectionOverUnionAuditorAgent, CXRGrounderCoordinator
from cxr_grounder.cli import main


def test_sub_agents():
    a1 = VisualEmbeddingSpatialAgent()
    ...
    a3 = IntersectionOverUnionAuditorAgent()
...
def test_coordinator():
    ...
    assert "DICOM SR / CheXpert Labeling Standards" in ans or "specifications" in ans
