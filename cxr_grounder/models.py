"""
Data Models & Telemetry Definitions for CXR-Grounder: Chest X-Ray Vision-Language Finding Localization Agent.
...
class AgentTelemetryAlert:
    ...
    standard_reference: str = "DICOM SR / CheXpert Labeling Standards"
    timestamp: str = field(default_factory=lambda: datetime.datetime.now(datetime.timezone.utc).isoformat())
