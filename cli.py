"""
Command Line Interface for Cxr Multimodal Report Grounder.
"""
import argparse
import csv
import sys
...
def main(argv=None):
    parser = argparse.ArgumentParser(prog="cxr-multimodal-report-grounder", description="Cxr Multimodal Report Grounder")
    ...
    if args.command == "audit":
        ...
        print("=" * 80)
        print(f"  CXR MULTIMODAL REPORT GROUNDER")
    ...
    if args.command == "chat":
        ...
        print(f"\n[Cxr Multimodal Report Grounder Supervisor]:\n{ans}\n")
        return 0
    ...
    if args.command == "serve":
        ...
        print(f"Starting Cxr Multimodal Report Grounder API server on http://{args.host}:{args.port}")
