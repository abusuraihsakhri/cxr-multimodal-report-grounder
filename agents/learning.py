"""
Autonomous Bayesian Calibration & Active Learning Feedback Engine for cxr-multimodal-report-grounder.
"""
...
class ActiveLearningEngine:
    ...
    def __init__(self, system_name: str = "Cxr Multimodal Report Grounder"):
